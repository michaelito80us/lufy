...
const Hero: React.FC<HeroProps> = ({ className }) => {
  return (
    <div className={`${className || ''}`}>
      ...
      <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-display font-bold tracking-tight mb-6 sm:mb-8 leading-tight">
      ...
      <p className="text-base sm:text-lg lg:text-xl text-gray-300 mb-4 sm:mb-6 leading-relaxed max-w-lg">
        Build a stunning futuristic dashboard that showcases your music, engages
        fans, and grows your brand.
      </p>

      <p className="text-sm sm:text-base text-gray-400 mb-8 sm:mb-12 max-w-lg">
